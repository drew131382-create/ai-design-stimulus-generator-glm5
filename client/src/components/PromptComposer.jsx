      ...
      <div className="flex flex-col gap-7">
        ...
        <Field label="产品" required error={formErrors.product}>
          <input
            ...
            placeholder="陪伴机器人"
            className={`w-full rounded-2xl border px-5 py-3.5 text-[17px] text-slate-800 shadow-[0_1px_2px_rgba(15,23,42,0.06)] outline-none transition duration-200 placeholder:text-sm placeholder:text-slate-400 focus:bg-white focus:ring-4 ${
              formErrors.product
              ...
              {OPTIONAL_FIELDS.map((field) => (
                ...
                >
                  <input
                    ...
                    className={`w-full rounded-2xl border px-4 py-3 text-base text-slate-800 shadow-[0_1px_2px_rgba(15,23,42,0.05)] outline-none transition duration-200 placeholder:text-sm placeholder:text-slate-400 focus:bg-white focus:ring-4 ${
